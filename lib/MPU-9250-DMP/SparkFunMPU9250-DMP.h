...
const signed char defaultOrientation[9] = {1, 0, 0, 0, 1, 0, 0, 0, 1};
...
public:
    ...
    inv_error_t update(unsigned char sensors = UPDATE_ACCEL | UPDATE_GYRO | UPDATE_COMPASS);
    ...
    // Output: INV_SUCCESS (0) on success, otherwise error
    inv_error_t dmpSetTap(unsigned short xThresh = 250, unsigned short yThresh = 250, unsigned short zThresh = 250,
                          unsigned char taps = 1, unsigned short tapTime = 100, unsigned short tapMulti = 500);
